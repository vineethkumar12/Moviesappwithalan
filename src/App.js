...
//import axios from 'axios';
function App() { 
const alankey='64646727431a428c463455fc755a860d2e956eca572e1d8b807a3e2338fdd0dc/stage'; 
...
{   for(let i=0;i<20;i++)
  {   
    ...
    {    window.open("https://www.themoviedb.org/movie/" + movies[i].id,"_blank",'menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes');
    console.log("number")
       break;
    }   
...
{   for(let i=0;i<20;i++)
  {   
    ...
    {    
      ...
      movies[i].id +"/videos?api_key=192a81102be79532153a351eb666c883&language=en-US").then(response=>{
...
// 6004b8fcb1604003b4ead57854e8d2c2
  return (
    ...
    <h1 className="movie text-6xl mb-3 font-bold">Discover .</h1> 
    <h1 className=" text-white  ml-40  text-2xl   "> The Best Movies</h1>  

       <div className='flex mt-1'>
           <img src='alan-logo.png' className=" h-8 ml-40 mt-2 "alt="nologo" />  
          
           <i className="fa-brands fa-github  fa-lg  ml-2 text-5xl  text-white"></i> 
        <button onClick={command}  className='text-center text-white ml-2 pl-1 pr-2 pl border mt-2 rounded-md h-7  bg-gradient-to-r from-yellow-500 via-pink-800 to-cyan-700'> commands</button>

           
       </div> 
       
         
       <div className='card  '><Moviescards totalmovies={movies}/></div> 
     <div className='video'> <Video videokey={videokey } comeback={comeback}/></div>
    < div className='commands'><Commands  commands={commands}/> </div> 
